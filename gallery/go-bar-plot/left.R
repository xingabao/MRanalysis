...
left.ui.layout <-  function() {
  tags$div(
    ...
    dropdown(
      tags$div(
        title = '',
        shiny::sliderInput(inputId = 'newline', label = 'Newline Threshold', min = 5, max = 25, value = 12, step = 1)
      ),
      tags$hr(),
      tags$div(
        title = '',
        shiny::sliderInput(inputId = 'axis_title', label = 'Axis Title', min = 0.1, max = 1, value = 0.5, step = 0.01)
      ),
      tags$div(
        title = '',
      ...
      tags$div(
        title = '',
        shiny::sliderInput(inputId = 'gene_symbol', label = 'Gene Symbol', min = 0.1, max = 1, value = 0.5, step = 0.01)
      ),
      tags$div(
        title = '',
        shiny::sliderInput(inputId = 'count', label = 'Count Number', min = 0.1, max = 1, value = 0.5, step = 0.01)
      ),
      tags$div(
        title = '',
        shiny::sliderInput(inputId = 'go_ontology', label = 'GO Ontology', min = 0.1, max = 1, value = 0.5, step = 0.01)
      ),
      tags$br(),
